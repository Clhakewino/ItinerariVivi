  ...
  return (
    <div className="relative min-h-screen bg-slate-900 text-white">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        <h1 className="text-5xl font-black leading-tight sm:text-6xl">Itinerari che vivono nella memoria</h1>
        <p className="mt-4 max-w-lg text-sm text-slate-100">Trova il percorso perfetto, pronto per partire oggi.</p>
